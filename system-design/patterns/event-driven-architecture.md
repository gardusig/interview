...
**Interview pacing:** Use [60-minute runbook](../prep/interview-runbook-60m.md) — ~10 min scoping (below), ~20 min diagram + CQRS split, ~45 min deep dive on **contract/versioning + orchestration boundaries**.
