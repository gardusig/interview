...
- `examples/README.md`
- `architecture/topics/cloud-services.md`
...
| --- | --- | --- | --- | --- | --- |
| A | Event-driven order pipeline | Design an order lifecycle at scale | #8 | `architecture/topics/messaging-async.md` | 3 |
| A | Transactional outbox | Avoid dual-write inconsistency | #10 | `architecture/topics/messaging-async.md` | 3 |
| A | Idempotency | Safe retries for APIs/webhooks | #12 | `architecture/topics/api-design.md` | 4 |
| A | Delivery semantics | Exactly-once vs at-least-once | #13 | `architecture/topics/messaging-async.md` | 3 |
...
| A | Observability across async | Trace and correlate events | #14 | `architecture/topics/messaging-async.md` | 3 |
| A | Failure recovery | Partial failure and compensation | #15 | `examples/infra/workflow-orchestration.md` | 3 |
| B | Consumer autoscaling | Lag-based scale policy | #16 | `architecture/topics/compute.md` | 2 |
| B | Multi-region inventory | Global reservations and TTL | #20 | `examples/commerce/multi-region-inventory-reservation.md` | 2 |
| B | Real-time delivery tracking | Websocket + pub/sub tracking | #21 | `architecture/topics/compute.md` | 2 |
| B | Distributed scheduler | Leases and retries | #23 | `examples/platform/distributed-job-scheduler.md` | 2 |
| B | Cross-service audit logging | Immutable audit/replay | #24 | `architecture/topics/security-networking.md` | 2 |
| B | Feature flag platform | Rollout and kill switch | #25 | `architecture/topics/data-stores.md` | 2 |
...
| C | Schema versioning governance | Safe contract upgrades | #9 | `architecture/topics/messaging-async.md` | 3 |
| C | DLQ/replay governance | Poison message runbooks | #11 | `architecture/topics/messaging-async.md` | 3 |
